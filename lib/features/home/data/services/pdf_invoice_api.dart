...
class PdfInvoiceApi {
  static Future<File> generate(
    ...
    pdf.addPage(MultiPage(
      ...
      footer: (context) => buildFooter(name),
    ));
  ...
  // static Widget buildTotal({required String total}) {
  ...
  static Widget buildFooter(String name) => Column(
        crossAxisAlignment: CrossAxisAlignment.center,
        children: [
          Divider(),
          SizedBox(height: 2 * PdfPageFormat.mm),
          buildSimpleText(title: 'Address', value: name),
          SizedBox(height: 1 * PdfPageFormat.mm),
          buildSimpleText(title: 'Paypal', value: name),
        ],
      );
